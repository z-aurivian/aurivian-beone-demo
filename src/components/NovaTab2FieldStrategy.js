...
const MSL_OPTIONS = ['S. Laurent — NE Region', 'M. Chen — MW Region', 'A. Okonkwo — SE Region', 'J. Park — SW Region', 'T. Weber — NW Region'];
...
const MSL_PERFORMANCE = [
  { msl: 'S. Laurent', territory: 'NE Region', status: 'Excellent',    interactions: 24, target: 20, delta: '+4', qualityScore: 82, kitSignals: 3, kolsAtRisk: 1, note: 'High interaction quality. Strong pediatric evidence focus.' },
  { msl: 'M. Chen',   territory: 'MW Region', status: 'On track',     interactions: 19, target: 20, delta: '−1', qualityScore: 76, kitSignals: 5, kolsAtRisk: 2, note: 'Switch messaging delivery improving month-on-month.' },
  { msl: 'A. Okonkwo',  territory: 'SE Region', status: 'Quality gap',  interactions: 21, target: 20, delta: '+1', qualityScore: 61, kitSignals: 2, kolsAtRisk: 3, note: 'Volume adequate, quality below target. KIT alignment coaching needed.' },
  { msl: 'J. Park', territory: 'SW Region', status: 'Volume gap',   interactions: 14, target: 20, delta: '−6', qualityScore: 79, kitSignals: 1, kolsAtRisk: 1, note: 'Quality strong but interactions below target. Coverage review needed.' },
  { msl: 'T. Weber',    territory: 'NW Region', status: 'Needs support',interactions: 12, target: 20, delta: '−8', qualityScore: 58, kitSignals: 2, kolsAtRisk: 4, note: 'Both volume and quality below target. Escalated to director.' },
];
...
const TERRITORY_BRIEFS = {
  ...
  'SE Region': 'SE Region shows a quality gap — 21 interactions (above target) but quality score of 61, below the 75 threshold. A. Okonkwo has strong congress-sourced signal capture but KIT alignment in MSL interactions is inconsistent. Three KOLs at engagement risk. C5 in gMG is the strongest awareness topic with the highest avg stage nationally (3.2).',
  'SW Region': 'SW Region is showing a volume gap — only 14 interactions against a target of 20. Quality score is strong at 79. One tier-1 KOL at risk. J. Park has captured the highest per-interaction quality in the team but needs territory coverage expansion. Patient advocacy signals are emerging.',
  'NW Region': 'NW Region requires immediate support — 12 interactions (60% of target) and quality score 58. T. Weber has 4 tier-1/2 KOLs with no substantive contact in the past 60 days. KIT coverage dots are below all other territories. Escalated to field director. Director brief and coaching plan recommended before next cycle.',
};
