...
export const TRIALS_ULTOMIRIS = [
  {
    nctId: 'BGB-11417-101',
    title: 'BGB-11417-101 — Sonrotoclax + Zanubrutinib in Treatment-Naive CLL/SLL',
    officialTitle: 'A Phase 1/1b Study of Sonrotoclax (BGB-11417) in Combination With Zanubrutinib in Participants With Previously Untreated Chronic Lymphocytic Leukemia/Small Lymphocytic Lymphoma',
    status: 'ACTIVE',
    phase: 'Phase 1/1b',
    conditions: ['CLL', 'Treatment-naive CLL', 'SLL'],
    interventions: ['Sonrotoclax', 'Zanubrutinib'],
    sponsor: 'BeiGene',
    startDate: '2022-11',
    completionDate: 'Estimated 2028',
    enrollment: 135,
    locationCount: 41,
    studyType: 'INTERVENTIONAL',
    keyFindings: 'Interim data (135 efficacy-evaluable patients): ORR 100%, CR 56.3% overall (59.5% at the 320mg RP2D dose); uMRD4 by week 24 up to 78%; estimated 30-month PFS 100%, no progressions observed.',
  },
  {
    nctId: 'NCT04408638',
