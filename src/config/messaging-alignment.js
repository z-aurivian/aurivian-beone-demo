...
export const MESSAGING_PILLARS = [
  { id: 'pillar-1', name: 'ALPINE Cardiovascular Safety vs Ibrutinib',  short: 'CV safety' },
  { id: 'pillar-2', name: 'Brukinsa CLL First-Line Utility',            short: 'CLL 1L' },
  { id: 'pillar-3', name: 'Tevimbra RATIONALE-302 OS Benefit',          short: 'RATIONALE-302' },
  { id: 'pillar-4', name: 'BTK+Venetoclax Combination Strategy',        short: 'BTK+ven combo' },
];
