...
export const LISTENING_PRIORITIES = [
  ...
  { id: 'LP4', name: 'BTK + venetoclax sequencing and combination strategy in R/R CLL',   moRef: 'MO4', kiq: 'How are CLL physicians approaching BTK + venetoclax combinations and what data are they waiting for?',                                         kits: ['BTK+ven combination data', 'BGB-11417-101 overview'] },
